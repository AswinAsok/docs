...
description: 'Organizers can view detailed information about any guest by clicking on their name. '
---
A modal will open displaying:

the basic details of the guest, including: **Name, Email, Ticket Code, Shortlisting Status, Registration Date & Time, Check-in Date & Time.**
...
<Frame>
  <img src="/images/event/guests/viewGuestTop.png" className="rounded-lg shadow-md" />
</Frame>
...
<Frame caption="this user has registered for the data-analytics-using-python sub event">
  <img src="/images/event/guests/childEvent.png" className="rounded-lg shadow-md" />
</Frame>
...
<Frame caption="view guest information in sub event showing, the user's parent event submission">
  <img src="/images/event/guests/parentevent.png" className="rounded-lg shadow-md" />
</Frame>
