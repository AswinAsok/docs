...
<Frame>
  <img src="/images/event/eventPage/eventTopBanner.png" className="rounded-lg shadow-md" />
</Frame>
...
<Frame>
  <img src="/images/event/eventPage/utm.png" className="rounded-lg shadow-md" />
</Frame>
...
<Frame>
  <img src="/images/event/eventPage/tagsModal.png" className="rounded-lg shadow-md" />
</Frame>
...
<Frame caption="Embed Form Modal">
  <img src="/images/event/eventPage/embedForm.png" className="rounded-lg shadow-md" />
</Frame>
...
<Frame >
  <img src="/images/event/eventPage/mailManagement.png" className="rounded-lg shadow-md" />
</Frame>
...
<Frame >
  <img src="/images/event/eventPage/mailModal.png" className="rounded-lg shadow-md" />
</Frame>